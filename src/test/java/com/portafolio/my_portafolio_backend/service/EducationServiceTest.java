...
public class EducationServiceTest {
    ...
    void testSaveValidEducation(){
        ...
        assertNotNull(educationRepository.findById(savedEducation.getId()), "El objeto guardado debe existir en la base de datos");
    }
    ...
    void testSaveInvalidInstitution(){
        ...
        assertThrows(ValidationException.class, () -> educationService.save(invalidEducation)
                    ,"Debe lanzarse una ValidationException cuando el nombre de la institucion este vacio");
    }
}
