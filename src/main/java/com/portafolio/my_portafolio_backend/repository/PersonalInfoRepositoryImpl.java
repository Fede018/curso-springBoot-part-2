...
public class PersonalInfoRepositoryImpl implements IPersonalInfoRepository{
    ...
    private final RowMapper<PersonalInfo> personalInfoRowMapper = (rs, numRow) -> {
        ...
        info.setYearsOfExperience(rs.getObject("years_of_experience", Integer.class)); // Usar getObjeect para nulos
    ...
    public PersonalInfo save(PersonalInfo personalInfo) {
        if(personalInfo.getId()==null){
            ...
            jdbcTemplate.update(connection -> {
                ...
                // Para tipos primitivos que pueden ser nulos en la BD (INT), usa setNull si el valor es Null
