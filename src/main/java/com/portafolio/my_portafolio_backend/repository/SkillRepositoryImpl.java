...
public class SkillRepositoryImpl implements ISkillRepository{
    ...
    private final RowMapper<Skill> skillRowMapper = (rs, numRow) -> {
        ...
        skill.setLevelPercentaje(rs.getInt("level_percentage"));
    ...
    public Skill save(Skill skill) {
        if(skill.getId()==null){
            ...
            jdbcTemplate.update(connection -> {
                ...
                ps.setInt(2, skill.getLevelPercentaje());
            ...
            String sql = "UPDATE skills SET name=?, level_percentage=?, icon_class=?, personal_info_id=? " +
                         "WHERE id=?";
            jdbcTemplate.update(sql,
                    skill.getName(),
                    skill.getLevelPercentaje(),
                    skill.getIconClass(),
